...
*/
function pSetupPoly4bc(aspectrum, aproc)
{	    
    pSetupSpecPropParams(aspectrum, aproc)	
    aproc.setParameter("BC[1].algorithm", "PolyFit"); //"PolyFit", "Whittaker" "Splines" here splines is cubic splines use     polyfit order=1 to match varian
    aproc.setParameter("BC[1].PolyOrder", 4);
