/*  
16Nov2023 rgpotter
This script or similar needs to run before any processing or unpredictable results will be obtained.  It sets up basic properties and parameters for the integration and resulting appearence of the spectrum.  Spectrum is raised above axis to show integral labels
*/
function pSetupRaisedTMSbc(aspectrum, aproc)
{	    
    ...
    aspectrum.setProperty("axes.margin.mm", 12.0);
