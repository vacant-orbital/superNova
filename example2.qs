function example2()
{   //potter Jun2024 jobscript for calculating mol percent furoic acid in acetic acid.  Displays blow up of 1.40 - 0.95 ppm region.
    ex2obj = new Pstudy();
    ...
    ex2obj.intfilename = "C:\\Users\\rpotter1\\OneDrive - JNJ\\Documents\\NMR\\text\\example2_int.dat"; 
    ex2obj.compfilename = "C:\\Users\\rpotter1\\OneDrive - JNJ\\Documents\\NMR\\text\\example2_comp.dat"; 
    ex2obj.pbox.macroname = "example2";
    ...
    ex2obj.createInset = {height : 80, width : 80, cuts : [[1.265,	1.210], [1.15,	1.097]], view : {xmin : 0.90, xmax : 1.40}, ints     : Integrals(), regs1 : [], mathFunc : null, normInt : null, newSpecArgs : {DCmin : 0.9, DCmax : 1.30},           coordsFile : "C:\\Users\\rpotter1\\OneDrive - JNJ\\Documents\\NMR\\text\\example2_coords.dat", mathFlag : false, zoom : 0.00, 
           };
