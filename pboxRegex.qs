...
function pboxRegex(aspectrum, apbox)
{
...
// some regex stuff for finding the date, original file path, etc.
    ...
    apbox["acqus"] = pConvertPathToWindows(usbFile).replace("fid", "acqus");
    apbox["acqusRegex"] = /##\$DS= (.*)/;
